...
// GetGopherNameBadRequestCode is the HTTP code returned for type GetGopherNameBadRequest
const GetGopherNameBadRequestCode int = 400

/*GetGopherNameBadRequest Invalid characters in "name" were provided.

swagger:response getGopherNameBadRequest
*/
type GetGopherNameBadRequest struct {
}

// NewGetGopherNameBadRequest creates GetGopherNameBadRequest with default headers values
func NewGetGopherNameBadRequest() *GetGopherNameBadRequest {

	return &GetGopherNameBadRequest{}
}

// WriteResponse to the client
func (o *GetGopherNameBadRequest) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
